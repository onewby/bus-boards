...
/// TflPeriodApiPeriodPresentationPeriodEntitiesPeriodArrivalDepartureWithLine : DTO to capture the prediction details
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct TflPeriodApiPeriodPresentationPeriodEntitiesPeriodArrivalDepartureWithLine {
...
impl TflPeriodApiPeriodPresentationPeriodEntitiesPeriodArrivalDepartureWithLine {
    /// DTO to capture the prediction details
    pub fn new() -> TflPeriodApiPeriodPresentationPeriodEntitiesPeriodArrivalDepartureWithLine {
        TflPeriodApiPeriodPresentationPeriodEntitiesPeriodArrivalDepartureWithLine {
            line_id: None,
            line_name: None,
            vehicle_id: None,
            platform_name: None,
